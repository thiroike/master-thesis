...
This mechanism assigns steeper gradients to images where the model currently lacks confidence, while providing gentler gradients to those for which the model can already produce stable predictions.
...
This period is established because the model's feature representation is immature in the early stages of learning,
...
Abrupt switching, such as that with a step function,
...
this enables simultaneously application of stronger learning signals to uncertain samples and weaker signals to well-learned samples.
