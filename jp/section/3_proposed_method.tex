...
その後，この不確実性情報を画像単位に集約し，PolyDice Loss の形状を動的に制御することで，モデルが現時点で確信を持てない画像には急峻な勾配を，既に安定した予測が可能な画像には緩やかな勾配を与える．
...
パラメータ $k$ は関数の応答感度を制御し，Fig. \ref{sigmoid} に示すようにその値が大きいほど難易度判定の境界が急峻になり，小さいほど滑らかな遷移となる．
...
現時点で確信を持てない画像には急峻な勾配を，既に安定した予測が可能な画像には緩やかな勾配を同時に与えることが可能となる．
